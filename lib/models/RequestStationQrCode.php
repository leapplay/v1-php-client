...
/**
 * RequestStationQrCode Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RequestStationQrCode implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RequestStationQrCode';
    ...
    public function setQrCode($qr_code)
    {
        if (!is_null($qr_code) && (mb_strlen($qr_code) > 128)) {
            throw new \InvalidArgumentException('invalid length for $qr_code when calling RequestStationQrCode., must be smaller than or equal to 128.');
        }
        if (!is_null($qr_code) && (mb_strlen($qr_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $qr_code when calling RequestStationQrCode., must be bigger than or equal to 1.');
        }
